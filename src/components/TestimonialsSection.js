...
export default function TestimonialsSection() {
  ...
  function handlePrev() {
    if (activeIndex === 0) setActiveIndex(testimonials.length - 1);
    else setActiveIndex((oldIndex) => oldIndex - 1);
  }

  function handleNext() {
    if (activeIndex >= testimonials.length - 1) setActiveIndex(0);
    else setActiveIndex((oldIndex) => oldIndex + 1);
  }
  return (
    <TestimonialSectionStyle>
      <div className="container">
        ...
        />
        <div className="testimonial__wrappper">
          <SwitchTransition>
